...
abstract class Component implements Parseable, ContentLine /* TODO implements Saveable */ {
	...
	protected static function getComponentClass($componentSpecification) {
		...
		return "Battis\\Calendar\\iCalendar\\RFC5545\\Components\\$componentClass";
	}
	...
	protected function isValidProperty(Property $property) {
		return is_a($property, NonstandardProperty::class) || array_key_exists(get_class($property), static::$validPropertyTypes);
	}
